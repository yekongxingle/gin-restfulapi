...
type (
	User struct {          //user就是table的名字
		ID uint `json:"id"`           //在表中的属性，分别显示id，phone等，都是小写
...
var (
	db *gorm.DB
	sqlConnection = "root:123456@tcp(127.0.0.1:3306)/restfulapi?charset=utf8&parseTime=true"
)
